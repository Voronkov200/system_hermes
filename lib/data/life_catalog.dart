...
class LifeCatalog {
  ...
  static const List<LifeAchievementDef> achievements = [
    ...
    LifeAchievementDef(
      id: 'clean_7',
      name: 'Стабильность',
      description: '7 дней обеих тренировок подряд',
      icon: 'verified',
      xp: 60,
    ),
    LifeAchievementDef(
      id: 'first_deposit',
      name: 'Вкладчик',
      description: 'Первые 50 BYN на общем счёте',
      icon: 'savings',
      xp: 80,
    ),
    LifeAchievementDef(
      id: 'first_usd',
      name: 'Твердая валюта',
      description: 'Первые 10 USD на виртуальной карте',
  ...
  static const List<LifeQuestDef> quests = [
    ...
    LifeQuestDef(
      ...
      description: 'Накопи 50 BYN на общем счёте',
      icon: 'credit_card',
      xp: 50,
    ),
    LifeQuestDef(
      index: 8,
      name: 'Первые доллары',
      description: 'Накопи 10 USD на виртуальной карте',
      icon: 'currency_exchange',
      xp: 60,
    ),
    LifeQuestDef(
