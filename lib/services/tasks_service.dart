// Задачи, которые ставит Анастасия (компаньон) и Hermes.
//
// Хранятся в Hive-боксе «tasks» (typeId 10). Анастасия может создавать
// задачи, отмечать выполненными и спрашивать про прогресс.
