...
| Модуль | Что делает |
|---|---|
| **Учёба** | Встроенные учебники и задания, локальный детерминированный разбор параграфа без ИИ и интернета, сохранение полного исходного текста и локальная работа с ГДЗ |
...
| **Жизнь и протокол** | Реальные действия, XP, достижения, тренировки и дисциплина без майнинга и фермы |
...
| **Настройки** | Тема, день начисления пенсии, папка Vault, URL/ключ Hermes, GitHub-репозиторий, сброс локальных данных |
