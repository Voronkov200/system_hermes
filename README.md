...
| **Companion: Анастасия** | ИИ-друг и наставник с Tool Calling (`create_obsidian_note`, `read_obsidian_note`, `web_search`, задачи, курсы). Affinity растёт только от реальных действий (выход из дома +15, фриланс +10, заметка >500 симв. +5, квест +5, тренировки +3, стрик 7 дней +25) — без штрафов и блокировок. Двухуровневая память: вечные `keyFacts` + свежий хвост (~25 сообщений) + суммаризация каждые ~50 сообщений |
